 ...
 */
function khleomix_parse_font_filename( $filename ) {
	$metadata = array(
		'family' => 'Unknown',
		'weight' => '400',
		'style'  => 'normal',
 ...
 */
function khleomix_scan_font_directory( $directory ) {
	$fonts     = array();
	...
	foreach ( $iterator as $file ) {
		if ( $file->isFile() && in_array( strtolower( $file->getExtension() ), array( 'woff2', 'woff', 'ttf', 'otf' ), true ) ) {
			...
			$font_metadata = khleomix_parse_font_filename( $filename );
			$fonts[]       = array(
 ...
 */
function khleomix_print_fonts( $fonts, $label = 'Fonts' ) {
...
$khleomix_build_fonts  = khleomix_scan_font_directory( 'build/fonts' );
$khleomix_assets_fonts = khleomix_scan_font_directory( 'assets/fonts' );
khleomix_print_fonts( $khleomix_build_fonts, 'Build Fonts' );
khleomix_print_fonts( $khleomix_assets_fonts, 'Assets Fonts' );
