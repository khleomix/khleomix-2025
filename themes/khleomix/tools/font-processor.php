...
function main() {
	...
	$fonts = scan_font_files( $khleomix_config['input_dir'] );
	...
	$copied_fonts = copy_fonts_to_output( $fonts, $khleomix_config['output_dir'] );
	...
	generate_font_preload( $copied_fonts, $khleomix_config['preload_output'] );
