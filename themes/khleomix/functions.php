<?php
/**
 * Khleomix functions and definitions.
 *
...
define( 'WebDevStudios\khleomix\ROOT_PATH', trailingslashit( get_template_directory() ) );
define( 'WebDevStudios\khleomix\ROOT_URL', trailingslashit( get_template_directory_uri() ) );
