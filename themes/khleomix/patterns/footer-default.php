...
$wds_copyright_info = esc_html__( 'Copyright &copy; ', 'khleomix' ) . esc_attr( gmdate( 'Y' ) );
?>
...
<footer class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
	...
	<div class="wp-block-columns" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
		...
		<div class="wp-block-column" style="flex-basis:66.66%">
			...
			<p class="has-white-color has-text-color has-link-color">WDS-BT stands for: <em>WebDevStudios Block Theme</em>. It can be found in the <a href="https://github.com/WebDevStudios/khleomix">khleomix github repo.</a>&nbsp; The theme is stood up on WDSLab: <a href="https://khleomix.wdslab.com">https://khleomix.wdslab.com</a>&nbsp;</p>
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"#f78766"}}}},"textColor":"white"} -->
