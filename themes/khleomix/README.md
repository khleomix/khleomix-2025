...
[![Code Quality](https://github.com/WebDevStudios/khleomix/actions/workflows/assertions.yml/badge.svg)](https://github.com/WebDevStudios/khleomix/actions/workflows/assertions.yml)
[![Security](https://github.com/WebDevStudios/khleomix/actions/workflows/security.yml/badge.svg)](https://github.com/WebDevStudios/khleomix/actions/workflows/security.yml)

<details>
 <summary><b>Table of Contents</b></summary>
 <a name="back-to-top"></a>

- [Khleomix V1.1.0](#khleomix-v110)
  - [Overview](#overview)
...
Khleomix is a foundational WordPress block theme designed for maximum flexibility and customization. It integrates seamlessly with the native WordPress block editor, providing an intuitive and adaptable user experience. Khleomix is specifically developed as a foundational rather than parent theme, giving developers a clean and versatile base for advanced customizations.
...
2. Activate Khleomix from your WordPress admin panel under Appearance > Themes.
...
Khleomix includes an automated font management system that organizes fonts by purpose and automatically generates the necessary files for optimal font loading and WordPress integration.
...
When `WP_DEBUG` is enabled, font detection debug information is displayed in the WordPress admin on the Khleomix Settings page.

**To enable debug:**
1. Set `WP_DEBUG = true` in your `wp-config.php`
2. Visit the Khleomix Settings page in WordPress admin
...
git add .
git commit -m "Khleomix-XXX - bump version to 1.4.0"
...
# 4. Commit changes
git add .
git commit -m "Khleomix-XXX - fix [specific issue]"

# 5. Commit version bump
git add .
git commit -m "Khleomix-XXX - bump version to 1.4.1"
...
# 5. Commit changes
git add .
git commit -m "Khleomix-XXX - add [new feature]"

# 6. Commit version bump
git add .
git commit -m "Khleomix-XXX - bump version to 1.5.0"
...
# 6. Commit changes
git add .
git commit -m "Khleomix-XXX - breaking: [description of breaking changes]"

# 7. Commit version bump
git add .
git commit -m "Khleomix-XXX - bump version to 2.0.0"
...
git add . && git commit -m "Khleomix-XXX - hotfix: [issue description]"
...
1. **Place Your Override SCSS Files**: Add your third‑party override SCSS files in `assets/scss/blocks/third-party/`.
   - **Naming Convention:** Name each file using the block's slug (the part after the namespace). For example, to override the `khleomix/test` block, name the file `test.scss`.
...
3. Use the `wp.blocks.registerBlockVariation()` function to officially register your block variation. This function takes the name of the original block and an object defining the variation.
 ...
 wp.blocks.registerBlockVariation('core/paragraph', {
  ...
  title: __('Custom Variation', 'khleomix'),
...
- **Custom Rules**:
  ...
  - Theme-specific prefix validation: `WebDevStudios\khleomix`, `wds`, `khleomix`
  - Text domain validation: `khleomix`
...
Khleomix integrates automated workflow actions to maintain high standards of code security, quality, and accessibility. Accessibility checks are built into the development process, ensuring that websites developed with Khleomix comply with WCAG 2.2 standards. This proactive approach reflects Khleomix's commitment to inclusivity and usability for all users.
...
- **How It Works**:
  - **URL Prompt**: The script prompts you for a site URL. Leaving it blank defaults to <https://khleomix.local>.
  ...
  **Example Output:**
  ...
  ```bash
  $ npm run a11y
  Please enter the URL to test for accessibility (leave blank to use your local: https://khleomix.local):
  > https://example.com
...
Your contributions and [support tickets](https://github.com/WebDevStudios/khleomix/issues) are welcome. Please see our [contributing guidelines](https://github.com/WebDevStudios/khleomix/blob/main/CONTRIBUTING.md) before submitting a pull request.

Khleomix is free software, and is released under the terms of the GNU General Public License version 2 or any later version. See [LICENSE.md](https://github.com/WebDevStudios/khleomix/blob/main/LICENSE.md) for complete license.
